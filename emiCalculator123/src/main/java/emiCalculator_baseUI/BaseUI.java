...
public void invokeproperties() {
	...
	public void navigateTo(String navKey) throws InterruptedException {
		Thread.sleep(4000);
		try {
	...
	public void loanAmountBySliderCar(String amountKey, String m1) throws InterruptedException {
		Thread.sleep(2000);
	...
	public void interestRateBySlider(String ratekey,String m1) throws InterruptedException {
		Thread.sleep(2000);
		double d = Double.parseDouble(m1);
		try {
		if(d>5) { 
	...
	public void loanTermBySliderYearCar(String termkey,String m1) throws InterruptedException {
		Thread.sleep(2000);
	...
	public void loanAmountBySliderHome(String AmountsliderH, String m1) throws InterruptedException {
		Thread.sleep(2000);
		double d = Double.parseDouble(m1);
		try {
		if(d>0)
	...
	public void loanTermBySliderYearHome(String tenuresliderH,String m1) throws InterruptedException {
		Thread.sleep(1000);
		double m = Double.parseDouble(m1);
		try {
		if(m>1) {
	...
	public void loanAmountByText(String amountKey,String data) throws InterruptedException {
		Thread.sleep(2000);
		try {
	...
	public void interestRateByText(String rateKey, String data) throws InterruptedException {
		Thread.sleep(2000);
		try {
	...
	public void loanTermByText(String termKey,String data) throws InterruptedException {
		Thread.sleep(2000);
		try {
	...
	public void displayCarLoanEMI(String firstYearKey, String firstMonthPrincipalAmt, String firstMonthInterestAmt, String noOfYears) throws Exception {
		try {
		 ...
		 String principalAmount = driver.findElement(By.xpath(prop.getProperty(firstMonthPrincipalAmt))).getText();
		  System.out.println("First month Principal Amount for Car Loan Rs: "+ principalAmount.substring(1));
		  reportPass("First month Principal Amount for Car Loan Rs: "+ principalAmount.substring(1));
		   String interestAmount = driver.findElement(By.xpath(prop.getProperty(firstMonthInterestAmt))).getText();
		 System.out.println("First month Interest Amount for Car Loan Rs: "+ interestAmount.substring(1)); 
		 reportPass ("First month Interest Amount for Car Loan Rs: "+ interestAmount.substring(1)); 
